...
Binary &Binary::sub(const Binary &other)
{
...
bool Binary::eq(const Binary &other) const
{
    if (_size != other._size)
    {
        return false;
...
bool Binary::ge(const Binary &other) const
{
    if (_size > other._size)
    {
        return true;
...
bool Binary::le(const Binary &other) const
{
    if (_size < other._size)
    {
        return true;
